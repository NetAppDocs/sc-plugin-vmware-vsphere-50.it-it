...
keywords:  
summary: 'Il plug-in SnapCenter VMware include un database MySQL (chiamato anche database NSM) che contiene i metadati per tutti i job eseguiti dal plug-in. È necessario eseguire regolarmente il backup di questo archivio.' 
---
...
[role="lead"]
Il plug-in SnapCenter VMware include un database MySQL (chiamato anche database NSM) che contiene i metadati per tutti i job eseguiti dal plug-in. È necessario eseguire regolarmente il backup di questo archivio.
