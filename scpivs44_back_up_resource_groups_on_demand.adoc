...
.Fasi
. Nel riquadro di sinistra del Navigator del plug-in SCV, fare clic su *gruppi di risorse*, quindi selezionare un gruppo di risorse, quindi selezionare image:scpivs44_image38.png["Icona di riproduzione"] *Esegui ora* per avviare il backup.
